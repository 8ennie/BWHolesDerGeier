 ...
 public class HolsDerGeier {
     ...
     */
     ...
     public static void main(String[] args) throws Exception {
		...
		HolsDerGeier testspiel = new HolsDerGeier();
		HolsDerGeierSpieler Bot1 = new IntelligentererGeier();
		HolsDerGeierSpieler Bot2 = new Random();
		testspiel.neueSpieler(Bot1,Bot2);
		testspiel.ganzesSpiel();
	}     
